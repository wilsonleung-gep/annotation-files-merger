...
function(Y) {
  ...
  Y.GEP.data = (function() {
    ...
    return {
      ...
      swfURL: appRoot + "/lib/yui/uploader/assets/flashuploader.swf?t=" + Math.random(),

      uploadURL: appRoot + "/services/process_upload.php",

      browserRoot: webRoot + "/cgi-bin/hgTracks?",
